...
function About() {
  return (
    <div>
        <section className="flex flex-col md:flex-row justify-between items-center bg-gradient-to-r from-blue-50 to-blue-100 py-16 px-8 md:px-16">
  {/* Text Section */}
  <div className="flex-1 text-gray-700 md:pr-8">
    <h1 className="text-3xl md:text-5xl font-extrabold text-blue-600 mb-4">About Us</h1>
    <div className="border-b-4 border-blue-600 w-24 mb-6"></div>
